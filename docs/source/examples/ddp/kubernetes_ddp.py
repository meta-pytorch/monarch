...
only when all resources are available), you can use [Kueue](https://kueue.sigs.k8s.io/). 
First, follow the [instructions](https://kueue.sigs.k8s.io/docs/installation/) to install Kueue. 
