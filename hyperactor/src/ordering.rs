...
impl Sequencer {
    ...
    pub fn assign_seq(&self, port_id: &addr::PortAddr) -> SeqInfo {
...
mod tests {
    ...
    fn test_sequencer_clone() {
        ...
        let actor_ref: crate::addr::ActorAddr = test_actor_id("test_0", "test").into();
    ...
    fn test_sequencer_actor_ports_share_sequence() {
        ...
        let actor_ref: crate::addr::ActorAddr = test_actor_id("worker_0", "worker").into();
        ...
        let actor_ref_2: crate::addr::ActorAddr = test_actor_id("worker_1", "worker").into();
    ...
    fn test_sequencer_non_actor_ports_have_independent_sequences() {
        ...
        let actor_ref_0: crate::addr::ActorAddr = test_actor_id("worker_0", "worker").into();
        let actor_ref_1: crate::addr::ActorAddr = test_actor_id("worker_1", "worker").into();
