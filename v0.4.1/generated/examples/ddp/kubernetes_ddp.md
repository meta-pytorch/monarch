...
This tutorial extends the [DDP using SPMDActor](spmd_ddp.html) tutorial to run PyTorch's Distributed
...
2. The [MonarchMesh CRD and operator](https://github.com/meta-pytorch/monarch-kubernetes/) installed
...
only when all resources are available), you can use [Kueue]([https://kueue.sigs.k8s.io/](https://kueue.sigs.k8s.io/)).
First, follow the [instructions]([https://kueue.sigs.k8s.io/docs/installation/](https://kueue.sigs.k8s.io/docs/installation/)) to install Kueue.
Then apply the quota and queue
configuration:
...
```
kubectl exec -it ddp-controller -n monarch-tests -- python /tmp/kubernetes_ddp.py --provision --num_hosts 2 --gpus_per_host 4 --queue user-queue
```
...
See the [complete manifest on GitHub](https://github.com/meta-pytorch/monarch/tree/main/docs/source/examples/ddp/manifests)
...
[`Download Python source code: kubernetes_ddp.py`](../../../_downloads/6ae5d3fa6e0bbc8ce5ea4c8ce2822189/kubernetes_ddp.py)

[`Download Jupyter notebook: kubernetes_ddp.ipynb`](../../../_downloads/9f98b40d721115296c16634af0b79137/kubernetes_ddp.ipynb)
