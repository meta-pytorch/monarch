...
[![Dashboard summary view showing overview cards, session timeline, status breakdown, error panel, and message traffic](_images/dashboard-summary.png)](_images/dashboard-summary.png)
...
[![Dashboard hierarchy view showing a breadcrumb bar and a table of actors with name, rank, and status columns](_images/dashboard-hierarchy.png)](_images/dashboard-hierarchy.png)
...
[![DAG view showing the full mesh topology as an interactive directed graph with color-coded nodes](_images/dashboard-dag.png)](_images/dashboard-dag.png)
