...
declare_attrs! {
    ...
    @meta(CONFIG = ConfigAttr {
        env_name: Some("OTEL_METRIC_EXPORT_INTERVAL_MS".to_string()),
        py_name: Some("otel_metric_export_interval_ms".to_string()),
    })
    pub attr OTEL_METRIC_EXPORT_INTERVAL_MS: u64 = 60000;
