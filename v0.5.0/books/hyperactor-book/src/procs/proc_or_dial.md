...
- [Host](host.html) - The container that uses `ProcOrDial`
- [Routers](../mailboxes/routers.html) - Details on `DialMailboxRouter`
- [MailboxSender](../mailboxes/mailbox_sender.html) - The trait `ProcOrDial` implements