...
See [Typed Message Lifecycle](../appendix/lifecycle.html) for the full end-to-end walkthrough, including serialization, framing, cancel-safe I/O, and deserialization.