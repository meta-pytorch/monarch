...
mod tests {
    ...
    fn parses_node_commands() {
        Cli::try_parse_from(["chrysalis-scale", "node", "udp://127.0.0.1:26600", "list"])
        ...
        Cli::try_parse_from(["chrysalis-scale", "node", "mast://scale_job", "list"])
