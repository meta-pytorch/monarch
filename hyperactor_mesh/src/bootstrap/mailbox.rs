    ...
    async fn test_proc_dialer() {
        ...
        let first_actor_id =
            hyperactor_reference::ProcId::from_resource_name(local_addr.clone(), first.to_string())
                .actor_id("actor", 0);
        let second_actor_id =
            hyperactor_reference::ProcId::from_resource_name(local_addr.clone(), second.to_string())
                .actor_id("actor", 0);
        ...
        let system_actor_id = hyperactor_reference::ProcId::from_resource_name(local_addr.clone(), "system")
            .actor_id("actor", 0);
        let envelope = MessageEnvelope::new(
            second_actor_id.clone(),
