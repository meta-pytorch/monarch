...
impl BootstrapProcHandle {
    ...
    /// process.
    pub(crate) fn new(proc_id: addr::ProcAddr, launcher: Weak<dyn ProcLauncher>) -> Self {
...
pub struct BootstrapProcManager {
    ...
    /// status.
    children: Arc<tokio::sync::Mutex<HashMap<addr::ProcAddr, BootstrapProcHandle>>>,
...
impl BootstrapProcManager {
    ...
    pub async fn status(&self, proc_id: &addr::ProcAddr) -> Option<ProcStatus> {
...
mod tests {
    ...
    async fn test_v1_child_logging() {
        ...
        let proc_ref: hyperactor::addr::ProcAddr = test_proc_id("client_0").into();
    ...
    mod proc_handle {
        ...
        fn handle_for_test() -> BootstrapProcHandle {
            let proc_id: hyperactor::addr::ProcAddr = test_proc_id("0").into();
