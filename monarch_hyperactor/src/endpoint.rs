...
/// `PythonTask` objects that resolve to individual actor responses.
/// This replaces the Python-side generator closure for better performance.
#[pyclass(
    name = "ValueStream",
    module = "monarch._rust_bindings.monarch_hyperactor.endpoint"
)]
...
impl PyValueStream {
    ...
    fn __next__(&self) -> PyResult<Option<PyPythonTask>> {
