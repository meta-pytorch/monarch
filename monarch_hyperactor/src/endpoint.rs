...
pub(crate) trait Endpoint {
    ...
    fn get_method_name(&self, py: Python<'_>) -> PyResult<String>;
    ...
    fn call<'py>(
        ...
        let method_name = self.get_method_name(py)?;
...
impl Endpoint for ActorEndpoint {
    ...
    fn get_method_name(&self, _py: Python<'_>) -> PyResult<String> {
        Ok(self.method.name().to_string())
    }
...
impl ActorEndpoint {
    ...
    #[getter]
    fn _signature(&self, py: Python<'_>) -> PyObject {
        self.signature
            .clone()
...
impl Endpoint for Remote {
    ...
    fn get_method_name(&self, py: Python<'_>) -> PyResult<String> {
        self.inner.call_method0(py, "_get_method_name")?.extract(py)
    }
