...
impl IbverbsConfig {
    ...
    /// let config = IbverbsConfig::targeting("cpu:0"); // closest to NUMA node 0
    /// let config = IbverbsConfig::targeting("cuda:1"); // closest to CUDA device 1
    ///
    /// // Direct device selection:
    /// let config = IbverbsConfig::targeting("nic:mlx5_3"); // use mlx5_3 directly
    /// ```
