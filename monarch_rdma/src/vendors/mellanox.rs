...
impl MlxBackend {
    fn is_mlx_device_impl(&self) -> bool {
...
impl NicBackend for MlxBackend {
    ...
    fn is_detected(&self) -> bool {
        *DETECTED.get_or_init(|| MlxBackend.is_mlx_device_impl())
    }
    ...
    fn apply_config_defaults(&self, _config: &mut IbvConfig) {
        // Default `IbvConfig` from primitives (e.g. gid_index 3) matches typical mlx5 IB setups.
    }
