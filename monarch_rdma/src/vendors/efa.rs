...
impl EfaBackend {
    fn is_efa_device_impl(&self) -> bool {
        ...
        unsafe {
            // TODO_ANDY: this shares a lot of logic as primitives::get_all_devices();
            // can probably swap out this logic with get_all_devices somehow (cf. broadcom.rs).
...
impl NicBackend for EfaBackend {
    ...
    // TODO_ANDY: make sure is_efa_device() isn't called elsewhere
    fn is_detected(&self) -> bool {
        *DETECTED.get_or_init(|| EfaBackend.is_efa_device_impl())
    }
