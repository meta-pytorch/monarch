...
//
// Currently unused; the next diff migrates [`IbvManagerActor`] onto
// these types, and a follow-up adds [`IbvProcessorActor`] which holds
// an [`Arc<SharedState>`] for read-only data-path access.
// ---------------------------------------------------------------------
