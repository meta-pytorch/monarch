...
1. Read the [getting started](generated/examples/getting_started.html) guide to understand the core concepts.
2. Check out the [Examples](generated/examples/index.html) directory for more detailed demonstrations
3. Explore the [API documentation](api/index.html) for a complete reference
